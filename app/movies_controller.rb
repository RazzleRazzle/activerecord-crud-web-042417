...
def can_be_found_updated_and_saved
  ...
  m_update = Movie.find_by(title: "Awesome Flick")
  m_update.title = "Even Awesomer Flick"
  m_update.save
end
...
def can_update_using_update_method
  ...
  m_update = Movie.find_by(title: "Wat?")
  m_update.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  doomed = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  doomed.destroy
end
